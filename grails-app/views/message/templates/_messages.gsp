<div class="row" id="messagesBox">
  <div id="messagesScroll" class="col-sm-9" style="position: relative; height: calc(100vh - 75px); overflow: auto;">
    ...
    <ul style="margin: 10px;">
      <g:each var="participant" in="${conversation.participants}">
        <g:if test="${participant.id != currentProfile.id}">
          <li>
            <g:link controller="profile" action="show" id="${participant.id}">
              ${participant.name}
            </g:link>
          </li>
        </g:if>
