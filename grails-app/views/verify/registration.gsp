    ...
    <div class="container">
      ...
      <div class="col-sm-6">
        ...
        <tempvs:ajaxForm controller="user" action="register">
          <tempvs:formField type="text" name="userProfile.firstName" label="user.firstName.label" />
          <tempvs:formField type="text" name="userProfile.lastName" label="user.lastName.label" />
          <tempvs:formField type="password" name="password" label="user.password.label" />
          <tempvs:formField type="password" name="repeatedPassword" label="user.repeatedPassword.label" />
